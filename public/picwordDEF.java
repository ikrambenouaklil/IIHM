...
public class picwordDEF extends JFrame implements ActionListener {
        Font ghostKidAOEPro;
        ...
        picwordDEF() throws FontFormatException, IOException {
                ...
                // --------------------les cohoix-----------------
                choix1 = Create.createTransparentButton("Owl", "labelchoix.png", 50);
                choix1.addActionListener(this);
                choix2 = Create.createTransparentButton("Bird", "labelchoix.png", 50);
                choix2.addActionListener(this);
                choix3 = Create.createTransparentButton("hawk", "labelchoix.png", 50);
                choix3.addActionListener(this);
                choix4 = Create.createTransparentButton("goshawk", "labelchoix.png", 50);
