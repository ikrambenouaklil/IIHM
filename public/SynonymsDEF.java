...
//palestine facile 
public class SynonymsDEF extends JFrame implements ActionListener {
        Font ghostKidAOEPro;
        JButton choix1, choix2, choix3, choix4, menu;

        SynonymsDEF() throws FontFormatException, IOException {
                ...
                ImageIcon imageMATHQSTF = new ImageIcon("fragile.png"); // la question
                // --------------------les cohoix-----------------
                choix1 = Create.createTransparentButton("Enduring", "labelchoix.png", 50);
                choix1.addActionListener(this);
                choix2 = Create.createTransparentButton("Formidable", "labelchoix.png", 50);
                choix2.addActionListener(this);
                choix3 = Create.createTransparentButton("weak", "labelchoix.png", 50);
