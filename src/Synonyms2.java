...
public class Synonyms2 extends JFrame implements ActionListener {
        Font ghostKidAOEPro;

        JButton choix1, choix2, choix3, choix4, menu;

        Synonyms2() throws FontFormatException, IOException {
                ...
                // --------------------les cohoix-----------------
                choix1 = Create.createTransparentButton("Unhappy", "labelchoix.png", 50);
                choix1.addActionListener(this);
                choix2 = Create.createTransparentButton("cheerful", "labelchoix.png", 50);
                choix2.addActionListener(this);
                choix3 = Create.createTransparentButton("Bad", "labelchoix.png", 50);
