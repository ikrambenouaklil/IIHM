...
//-------------------bg-------------------
        ...
        //--------------------les cohoix----------------- 
        JButton choix1 = Create .createTransparentButton("Owl", "labelchoix.png");
        JButton choix2 = Create .createTransparentButton("Bird", "labelchoix.png");
        JButton choix3 = Create .createTransparentButton("hawk", "labelchoix.png");
        JButton choix4 = Create .createTransparentButton("goshawk", "labelchoix.png");
