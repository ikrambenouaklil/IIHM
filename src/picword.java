...
public class picword extends JFrame {
        Font ghostKidAOEPro ;
...
//-------------------bg-------------------
        ...
        //--------------------les cohoix----------------- 
        JButton choix1 = Create .createTransparentButton("Bear", "labelchoix.png");
        JButton choix2 = Create .createTransparentButton("Elephant", "labelchoix.png");
        JButton choix3 = Create .createTransparentButton("tiger", "labelchoix.png");
        JButton choix4 = Create .createTransparentButton("cat", "labelchoix.png");
